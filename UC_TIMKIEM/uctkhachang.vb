...
Namespace UC_TIMKIEM
	Public Partial Class uctkhachang
		...
		Private Sub txttenkhachhang_KeyPress(sender As Object, e As KeyPressEventArgs)
		...
		Private Sub txtmakhachhang_KeyPress(sender As Object, e As KeyPressEventArgs)
            If e.KeyChar = Chr(13) Then
                For Each mdiChild As Form In Main.ActiveForm.MdiChildren
                    If mdiChild.Name = "frmTimKetQua" Then
                        mdiChild.Activate()
